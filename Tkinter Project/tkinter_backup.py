...
def backup_files():
    direct_to_copy = backup_dir_var.get()  # Use the StringVar value for the source
    destination_directory = destination_dir_var.get()  # Use the StringVar value for the destination
...
def select_backup_directory():
    ...
    if directory:  # Check if a directory was selected
        backup_dir_var.set(directory)  # Update the StringVar with the selected path
...
def select_destination_directory():
    directory = askdirectory()
    if directory:  # Check if a directory was selected
        destination_dir_var.set(directory)  # Update the StringVar with the selected path
...
title_combobox.set("No")  # Set default value
